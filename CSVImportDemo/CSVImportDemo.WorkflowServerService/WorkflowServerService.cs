...
namespace CSVImportDemo.WorkflowServerService {
    public partial class CSVImportDemoWorkflowServer  : System.ServiceProcess.ServiceBase {
        private WorkflowServer server;
        protected override void OnStart(string[] args) {
            if(server == null) {
                ServerApplication serverApplication = new ServerApplication();
                serverApplication.ApplicationName = "CSVImportDemo";
                ...
                serverApplication.Modules.Add(new CSVImportDemo.Module.CSVImportDemoModule());
                serverApplication.Modules.Add(new CSVImportDemo.Module.Web.CSVImportDemoAspNetModule());
        ...
        public CSVImportDemoWorkflowServer() {
            InitializeComponent();
        }
    }
}
