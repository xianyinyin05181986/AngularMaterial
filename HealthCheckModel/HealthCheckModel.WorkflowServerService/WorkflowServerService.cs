...
namespace HealthCheckModel.WorkflowServerService {
    public partial class HealthCheckModelWorkflowServer  : System.ServiceProcess.ServiceBase {
        private WorkflowServer server;
        protected override void OnStart(string[] args) {
            if(server == null) {
                ServerApplication serverApplication = new ServerApplication();
                serverApplication.ApplicationName = "HealthCheckModel";
                ...
                serverApplication.Modules.Add(new HealthCheckModel.Module.HealthCheckModelModule());
                serverApplication.Modules.Add(new HealthCheckModel.Module.Web.HealthCheckModelAspNetModule());
        ...
        public HealthCheckModelWorkflowServer() {
            InitializeComponent();
        }
    }
}
